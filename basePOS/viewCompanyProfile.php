...
{ 
   ...
   // Check if image file is a actual image or fake image
    ...
    $updateComprofile = "UPDATE `comprofile` SET `title` = '".$title."', 
						`orgname`  = '".$orgname."',`portal`  = '".$portal."',`orgtype`  = '".$orgtype."',`blocation`  = '".$blocation."',
						`industry`  = '".$industry."',`address`  = '".$address."',`city`  = '".$city."',`state`  = '".$state."',`country`  = '".$country."',
						`zip`  = '".$zip."',`workphone`  = '".$workphone."',`mobile`  = '".$mobile."',`web`  = '".$web."',`gstin`  = '".$gstin."',
						`gstregdate`  = '".$gstregdate."',`image`  = '".$target_file."'
						 WHERE `id` =". $compId;
								...
								<?php
                                        ...
                                        if(isset($_GET['id']))
                                        {
                                            ...
                                            $result = mysqli_query($dbcon, "SELECT concat(prefix,id) as orgid,title,orgname,portal,orgtype,blocation,
																	industry,address,city,state,country,zip,workphone,mobile,email,web,gstin,gstregdate,image
									...
									<div class="form-group col-md-4">
                                                <select id="inputState" class="form-control form-control-sm" name="state">
                                                    ...
                                                    <option <?php if ($state == "DL" ) echo 'selected="selected"' ; ?> value="DL">Delhih</option>
											...
											<div class="form-group col-md-4">
											<select class="form-control form-control-sm" id="example1" name="country"> 
