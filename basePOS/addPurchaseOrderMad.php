							...
							<div class="card-body">
								...
								<div class="form-row">
									...
									<div class="form-row">
										...
										<div class="form-row">
                                            <div class="form-group col-md-8">
                                                ...
                                                <select id="compcode" onchange="onsupcode(this);" class="form-control form-control-sm" name="supcode">
                                                    ...
                                                    <?php 
                                                    include("database/db_conection.php");//make connection here
                                                    $sql = mysqli_query($dbcon,"SELECT distinct(vendorid), supname
																			FROM vendorprofile  JOIN purchaseorders
																			ON vendorprofile.vendorid = purchaseorders.po_vendor");
                                                      while ($row = $sql->fetch_assoc()){	
                                                ...
                                                <script>
                                                    ...
                                                    {    
                                                        var supcode=x.value;
                                                        window.location.href = 'addPurchaseOrderMad.php?supcode='+supcode;
                                                    }
                                                </script>
                                            </div>
                                        </div>
										...
										<div class="form-row">
                                            <div class="form-group col-md-8">
											<h5 class="col-md-12 text-muted">PO #</h5>
											<select id="ponumber" onchange="onpocode(this);" class="form-control form-control-sm" name="ponumber">
												 ...
												 include("database/db_conection.php");//make connection here
												  if (isset($_GET["supcode"])) {
                                                    ...
                                                    $sql = mysqli_query($dbcon,"SELECT * from purchaseorders where po_vendor = $sup_code");
											        while ($row = $sql->fetch_assoc()){	
                                                     if($sup_code==$row['po_vendor']){														 
													   echo $ponum=$row['po_code'];
													//echo $vendorname=$row['supname'];
													echo '<option onchange="'.$row[''].'" value="'.$ponum.'" >'.$ponum.'</option>';
											...
											<script>
                                                    function onpocode(x)
                                                    {    
                                                        var ponumber=x.value;
                                                        window.location.href = 'addPurchaseOrderMad.php?ponumber='+ponumber;
                                                    }
                                                </script>
										...
										<div class="form-row">
                                            <div class="form-group col-md-8">
                                                <label for="inputState">Po #<span class="text-danger">*</span></label>
                                                <select id="compcode" onchange="onsupcode(this);" class="form-control form-control-sm" name="supcode">
                                                    <option selected>Open PO Code</option>
                                                    <?php 
                                                    include("database/db_conection.php");//make connection here
                                                    $sql = mysqli_query($dbcon,"SELECT po_code from purchaseorders");
                                                      while ($row = $sql->fetch_assoc()){	
                                                        echo $pocode_get=$row['po_code'];
                                                        if($pocode_get==$_GET['po_code']){
                                                                echo '<option value="'.$supcode_get.'"  selected>'.$supcode_get.'</option>';  
                                                        }else{
                                                            echo '<option value="'.$supcode_get.'" >'.$supcode_get.'</option>';      
                                                        }
								...
								<a data-target="#customModal" data-toggle="modal" style="color:#0056b3">
...
<tr>
	...
	<td><input type="text" name="price[]" placeholder="price"    data-id="" class="form-control price"></td>
	<td><input type="text" name="qty[]"   placeholder="Quantity" data-id="" class="form-control qty"></td>
	<td><input type="text" name="amount[]" placeholder="PriceXQty" data-id="" class="form-control amount"></td>
	<!-- <td><input type="text" name="discount[]" class="form-control discount" placeholder="Itm wise Disc"></td> -->
	<td><input type="text" name="gst[]" placeholder="GST if avail Itemwise" data-id=""  class="form-control gst" ></td>
