            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="breadcrumb-holder">
                        <h1 class="main-title float-left">HL Balance Report</h1>
                        <ol class="breadcrumb float-right">
                            <li class="breadcrumb-item">Home</li>
                            <li class="breadcrumb-item active">HL Balance Report</li>
                        </ol>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    <div class="card mb-3">
                        <div class="card-header">
                            ...
                            <h3><i class="fa fa-cart-plus bigfonts" aria-hidden="true"></i><b>&nbsp;HL Balance Report </b></h3>
                        </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="form-group col-md-3">
                                    <select id="partywise" class="form-control form-control-sm" name="partywise">
                                        ...
                                        <?php
                                        $sql = mysqli_query($dbcon,"SELECT * FROM payeemaster WHERE amount !=0");
