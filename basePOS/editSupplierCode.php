...
{ 
	var_dump($_POST);
	extract($_POST);
    $updateSupplier = "UPDATE `suppcode` SET  `title` = '".$title."',`suppname` = '".$suppname."',`supptype` = '".$supptype."' WHERE `id` =".$suppID;
    if(mysqli_query($dbcon,$updateSupplier))
    {
					...
					<div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 col-xl-8">						
						<div class="card mb-3">
							...
							<div class="card-body">
								...
								<form action="editSupplierCode.php"  enctype="multipart/form-data" method="post" accept-charset="utf-8" novalidate="novalidate"><button type="submit" class="fv-hidden-submit" style="display: none; width: 0px; height: 0px;"></button>
								...
								<?php
											...
											if(isset($_GET['id']))
											{
												...
												$result = mysqli_query($dbcon, "select concat(prefix,postfix,postfix2,id) as Suppcode,title,suppname,supptype,id from suppcode WHERE id=$id");									 
								  ...
								  <div class="form-row">
									<div class="form-group col-md-4">
									  ...
									  <input type="text" class="form-control" name="suppcode" readonly value="<?php echo $suppcode;?>" />
									</div>
									</div>
								  ...
								  <div class="form-row">
									...
									<div class="form-group col-md-6">
									  ...
									  <input type="text" class="form-control" name="suppname" value="<?php echo $name;?>" />
									</div>
									</div>	
									...
									<div class="form-group col-md-6">
									  ...
									  <input type="text" class="form-control" name="supptype" value="<?php echo $supptype;?>" />
									</div>
									</div>
