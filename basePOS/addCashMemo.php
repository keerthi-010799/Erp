                            ...
                            <form id="add_cashmem_form" autocomplete="off" action="#">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-8">
                                        ...
                                        <input type="text" placeholder="Customer Reference No" hidden name="inv_cust_ref_phno" id="inv_cust_ref_phno" class="form-control form-control-sm"> 
...
<input type="text" placeholder="INV-000001" name="inv_receipt_no" id="inv_receipt_no" class="form-control form-control-sm"> 
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <select required  id="inv_paymentmode" data-parsley-trigger="change"  required class="form-control form-control-sm"  name="inv_paymentmode" >
                                ...
                                <div class="form-row">                                
                                    <div class="form-group col-md-4">											
                                        ...
                                        <select id="inv_deliveryat" onchange="ondelat(this)" readonly class="form-control form-control-sm" name="inv_deliveryat">
                                    ...
                                    <div class="form-group col-md-4" >
                                        ...
                                        <select class="form-control form-control-sm" readonly required name="inv_status"  id="inv_status">
...
<td><input type="text" name="itemcode" placeholder="Item Details" class="form-control"></td>-->
                                ...
                                <div class="form-row col-md-12">
                                    <div class="form-group col-md-8">
                                        <textarea rows="2" class="form-control" name="inv_tc"  id="inv_tc" readonly placeholder=""></textarea>

                                    </div>

                                    <div class="form-row col-md-12">
                                        <div class="form-group col-md-8">
                                            <textarea rows="2" class="form-control" name="inv_notes"  id="inv_notes"  placeholder="add Cash Memo Notes[optional]"></textarea>
                                        </div>
                                    </div>
