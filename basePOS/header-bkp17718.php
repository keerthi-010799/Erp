															...
															<div class="panel-body">
																<div class="table-responsive">
																	<table class="table table-condensed">
																		<thead>
																			<tr>
																				<td><font color="grey"><i class="fa fa-shopping-basket" aria-hidden="true"><strong>&nbsp;PURCHASES</strong></font></i></td>
																				<td class="text-right"><font color="grey"><i class="fa fa-shopping-cart"><strong>&nbsp;SALES</strong></font></i></td>
																				<td class="text-center"><font color="grey"><i class="fa fa-truck smallfonts" aria-hidden="true"><strong>&nbsp;INVENTORY/STOCK TRANSFERS</strong></font></i></td>
																				<td class="text-right"><font color="grey"><i class="fa fa-th-large bigfonts" aria-hidden="true"><strong>&nbsp;GENERAL</strong></font></i></td>
																			</tr>
																		</thead>
																		<tbody>
																			<!-- foreach ($order->lineItems as $line) or some such thing here -->
																			<tr>
																				<td><a target="_blank" href="addPurchaseOrder.php">
																					<i class="fa fa-plus bigfonts" aria-hidden="true">&nbsp;Purchase Order</i></a></td>
																				<td class="text-right"><a target="_blank" href="addPurchaseOrder.php">
																					<i class="fa fa-plus bigfonts" aria-hidden="true">&nbsp;Estimates</i></a></td>
																				<td class="text-left"><a target="_blank" href="addPurchaseItemMaster.php">
																					<i class="fa fa-plus bigfonts" aria-hidden="true"><b>&nbsp;Product Inward(Purchase Items)</b></i></a></td>
																				<td class="text-right"><a target="_blank" href="addCustomerProfile.php">
																					<i class="fa fa-plus bigfonts" aria-hidden="true"><b>&nbsp;Customer</b></i></a></td>
																			</tr>
																			<tr>
																				<td><a target="_blank" href="addGoodsReceiptNote.php">
																					<i class="fa fa-plus bigfonts" aria-hidden="true">&nbsp;GRN(Purchase Bills)</i></a></td>
																				<td class="text-right"><a target="_blank" href="addSalesOrder.php">
																					<i class="fa fa-plus bigfonts" aria-hidden="true">&nbsp;Sales Order</i></a></td>
																				<td class="text-left"><a target="_blank" href="listPurchaseItemMaster.php">
																					<i class="fa fa-plus bigfonts" aria-hidden="true"><b>&nbsp;Adjust Stock&Price(Inward Items)</b></i></a></td>
																				<td class="text-right"><a target="_blank" href="addVendorProfile.php">
																					<i class="fa fa-plus bigfonts" aria-hidden="true"><b>&nbsp;Vendor</b></i></a></td>
																			</tr>
																			<tr>
																				<td><a target="_blank" href="addVendorPayments.php">
																					<i class="fa fa-plus bigfonts" aria-hidden="true">&nbsp;Vendor Payments</i></a></td>
																				<td class="text-right"><a target="_blank" href="addInvoice.php">
																					<i class="fa fa-plus bigfonts" aria-hidden="true">&nbsp;Invoices</i></a></td>
																				<td class="text-left"><a target="_blank" href="addSalesitemMaster.php">
																					<i class="fa fa-plus bigfonts" aria-hidden="true"><b>&nbsp;Product Outward(Sales Items)</b></i></a></td>
																				<td class="text-right"><a target="_blank" href="addSupplierBankDetails.php">
																					<i class="fa fa-plus bigfonts" aria-hidden="true"><b>&nbsp;</b>Vendor Bank</i></td>
																			</tr>
																			<tr>
																				<td><a target="_blank" href="addVendorCredits.php">
																					<i class="fa fa-plus bigfonts" aria-hidden="true">&nbsp;Vendor Credits</i></a></td>
																				<td class="text-right"><a target="_blank" href="listInvoices.php">
																					<i class="fa fa-plus bigfonts" aria-hidden="true">&nbsp;Print Delivery Challan</i></a></td>
																				<td class="text-left"><a target="_blank" href="listSalesItemMaster.php">
																					<i class="fa fa-plus bigfonts" aria-hidden="true"><b>&nbsp;Adjust Stock/Price(Outward Items)</b></i></a></td>
																				<td class="text-right"><a target="_blank" href="addUsers.php">
																					<i class="fa fa-plus bigfonts" aria-hidden="true"><b>&nbsp;</b>add Users</i></a></td>
																			</tr>
																			<tr>
																				<td><a target="_blank" href="listDebitNotes.php">
																					<i class="fa fa-plus bigfonts" aria-hidden="true">&nbsp;Print Debit Note</i></a></td>
																				<td class="text-right"><a target="_blank" href="addCashMemo.php">
																					<i class="fa fa-plus bigfonts" aria-hidden="true">&nbsp;Cash Memo/Retail Invoice</i></a></td>
																				<td class="text-left"><a target="_blank" href="transferProductInward.php">
																					<i class="fa fa-plus bigfonts" aria-hidden="true"><b>&nbsp;Stock Transfers(Inward to Locations)</b></i></a></td>
																				<td class="text-right"></td>
																			</tr>
																			<tr>
																				<td><a target="_blank" href="addExpenses.php">
																					<i class="fa fa-plus bigfonts" aria-hidden="true">&nbsp;Expenses</i></a></td>
																				<td class="text-right"><a target="_blank" href="addCustomerReceipts.php">
																					<i class="fa fa-plus bigfonts" aria-hidden="true">&nbsp;Customer Payments</i></a></td>
																				<td class="text-left"><a target="_blank" href="transferProductInward.php">
																					<i class="fa fa-plus bigfonts" aria-hidden="true"><b>&nbsp;Stock Transfers(Inward to Outward)</b></i></a></td>
																				<td class="text-right"></td>
																			</tr>
																			
																			<tr>
																				<td><a target="_blank" href="addExpenses.php"></td>
																				<td class="text-right"><a target="_blank" href="listInvoices.php">
        ...
        <div id="main">
            ...
            <div class="headerbar">
                ...
                <div class="headerbar-left">
                    <a href="index.php" class="logo"><!--img alt="Logo" src="assets/images/logo.jpg" /--> <font color="yellow"><span><b>Loyal Agro Products</b></span></font></a>
                </div>
