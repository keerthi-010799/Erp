	...
	<div class="row h-100 align-items-center">
	   <div class="col-md-4 offset-md-4">
		<div class="card">
			...
			<img alt="Logo" src="assets/images/avatars/favicon.jpeg" alt="Profile image" width="290" height="170" /> 
			<div class="invoice-title text-center mb-3">SRI MAHESHWARI TEXTILES</a></div></h3>
