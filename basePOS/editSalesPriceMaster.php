...
{ 
    ...
    $updateSalespricemaster = "UPDATE salespricemaster set    `taxmethod` =  '".$taxmethod."'	
												,`taxrate` 	=  '".$taxrate."'
												,`priceperqty` =  '".$priceperqty."'		
												,`priceperuom` =	 '".$priceperuom."'
												,`datefrom` =  '".$datefrom."'
												,`notes`  =  '".$notes."'
										WHERE `id` =".$salesPriceID;
	//echo $updateUser;
    if(mysqli_query($dbcon,$updateSalespricemaster))
    {
		echo "<script>alert('Update Sales Price Successfully Updated')</script>";
...
<div id="main">
					...
					<div class="col-xl-12">
							<div class="breadcrumb-holder">
                                    ...
                                    <ol class="breadcrumb float-right">
										...
										<li class="breadcrumb-item active">Edit Sales Price Master</li>
                                    </ol>
                                    <div class="clearfix"></div>
                            </div>
					</div>
			...
			<div class="row">
                    ...
                    <div class="col-xs-10 col-sm-10 col-md-6 col-lg-6 col-xl-6">						
						...
						<div class="card-header">
								...
								<h5<i class="fa fa-rupee bigfonts" aria-hidden="true"></i>&nbsp;Edit Sales Price Master</b></h5>
								 </div>
	...
	<div class="container">
									...
									<form method="post" action="editSalesPriceMaster.php" enctype="multipart/form-data">
                                    <?php
                                        include("database/db_conection.php");//make connection here
										if(isset($_GET['id']))
                                        {
                                            ...
                                            $result = mysqli_query($dbcon, "SELECT * FROM salespricemaster WHERE id=$id");
									...
									<div class="modal-footer">
										<input type="hidden" name="salesPriceID" value="<?=$_GET['id']?>">
										<button type="submit" name="salesPriceEdit" value="salesPriceEdit" class="btn btn-primary">Update</button>
									</div>
									</div>
