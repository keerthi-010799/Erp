						...
						<div class="card mb-3">
							...
							<div class="card-body">
										...
										<form data-parsley-validate novalidate method="POST" enctype="multipart/form-data">
											...
											<div class="form-group">
                                                ...
                                                <select id="compcode" onchange="oncompcode(this);" class="form-control" name="compcode">
                                                    ...
                                                    <?php 
                                                    include("database/db_conection.php");//make connection here
                                                    $sql = mysqli_query($dbcon,"SELECT orgid
																				FROM comprofile
																				ORDER BY id ASC
																				");
								...
								<!--a role="button" href="" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">
								 ...
								 <!--div class="font-xs" data-ember-action="" data-ember-action-1734="1734"-->  
								 <a href="#custom-modal" data-target="#customModal" data-toggle="modal">							 
								<i class="fa fa-user-plus" aria-hidden="true"></i>Add Groups</a>
								  ...
								  <div class="modal-dialog" role="document">
									<div class="modal-content">
									  ...
									  <div class="modal-footer">
										...
										<button type="button" name="submitgroup" id="submitgroup" class="btn btn-primary">Save changes</button>
									  </div>
									</div>
								  </div>
								</div>
		...
		$.ajax ({
           ...
           success:function(response){
				if(response!=0){
					...
					alert('Error in inserting new Group');
				}
			}
