...
if(isset($_POST['compTypEdit']))
{ 
	var_dump($_POST);
	extract($_POST);
    $updateUser = "UPDATE `comptypecode` SET `title` = '".$title."',`name` = '".$cname."',`ctype` = '".$ctype."',`location` = '".$locname."'
	WHERE `id` =".$compTypId;
    if(mysqli_query($dbcon,$updateUser))
    {
		echo "<script>alert('Company Type Details Successfully updated')</script>";
		header("location:listCompanyType.php");
			...
			<div class="container-fluid">
					...
					<div class="col-xl-12">
							<div class="breadcrumb-holder">
                                    <h1 class="main-title float-left">Edit Oraganization Master</h1>
                                    <ol class="breadcrumb float-right">
									<a  href="index.php"><li class="breadcrumb-item">Home</a></li>
										<li class="breadcrumb-item active">Edit Oraganization Master</li>
                                    </ol>
                                    <div class="clearfix"></div>
                            </div>
					</div>
					...
					<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">						
						<div class="card mb-3">
							<div class="card-header">
								...
								<h3><div class="fa-hover col-md-8 col-sm-8"><i class="fa fa-bank smallfonts" aria-hidden="true">
								</i>&nbsp;Edit Oraganization Master <span class="text-muted"></span></div></h3>
							...
							<div class="card-body">
								...
								<form autocomplete="off" action="editCompType.php" enctype="multipart/form-data" method="post">
								...
								<?php
											...
											if(isset($_GET['id']))
											{
												...
												$result = mysqli_query($dbcon, "SELECT * FROM comptypecode WHERE id=$id");
									...
									<div class="form-group col-md-10">
									  ...
									  <input type="text" class="form-control" name="ctype" placeholder="Individual,Corporate,Registered,Branch" value="<?php echo $ctype;?>" />
									</div>
									</div>
								    ...
								    <div class="form-group text-right m-b-10">
															<input type="hidden" name="compTypId" value="<?=$_GET['id']?>">
                                                       &nbsp;<button class="btn btn-primary" name="compTypEdit" type="submit">
                                                            Update
                                                        </button>                                                       
                                                    </div>
													</div>
