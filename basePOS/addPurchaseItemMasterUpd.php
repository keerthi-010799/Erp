						...
						<div class="card mb-3">
							...
							<div class="form-row">
									<div class="form-group col-md-3">
									  ...
									  <select id="inputState" onchange="gettaxrate()" class="form-control form-control-sm" name="taxmethod">
									...
									<div class="form-group col-md-3">
                                                ...
                                                <select id="onshpvia" onchange="gettaxrate()" required class="form-control form-control-sm" name="taxname">
                                                    <option value="0" selected>Open Taxrate</option>
                                                    <?php 
                                                    include("database/db_conection.php");//make connection here

                                                    $sql = mysqli_query($dbcon, "SELECT taxname,salestaxrate FROM taxmaster where purchaseoption = '1'");
                                                    while ($row = $sql->fetch_assoc()){	
                                                         $taxname=$row['taxname'];
								...
								<div class="form-row">
									...
									<div class="form-group col-md-3">									
									<label>Tax Amount&nbsp;<span class="text-danger"></label>
									...
									<div class="form-group col-md-3">									
									<label>Final Price&nbsp;<span class="text-danger">
									 <span class="text-danger"></label>
...
<script>
	function gettaxrate(){
		var taxrate = document.getElementById('onshpvia').value;
		var taxmethod = document.getElementById('inputState').value;
