...
if(isset($_POST['transMasterEdit']))
{ 
	var_dump($_POST);
	extract($_POST);
    $updateTrasportMaster = "UPDATE `transportmaster` SET `transname` = '".$transname."',`vtype` = '".$vtype."'
	WHERE `id` =".$transMasterId;
    if(mysqli_query($dbcon,$updateTrasportMaster))
    {
		echo "<script>alert('Transport Master Details Successfully updated')</script>";
			...
			<div class="container-fluid">
					...
					<div class="col-xl-12">
							<div class="breadcrumb-holder">
                                    <h1 class="main-title float-left">Edit Transport Master</h1>
                                    <ol class="breadcrumb float-right">
									<a  href="index.php"><li class="breadcrumb-item">Home</a></li>
										<li class="breadcrumb-item active">Edit Transport Master </li>
                                    </ol>
                                    <div class="clearfix"></div>
                            </div>
					</div>
					...
					<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">						
						<div class="card mb-3">
							<div class="card-header">
								...
								<h3><i class="fa fa-truck smallfonts" aria-hidden="true"></i>&nbsp;Edit Transport Master <span class="text-muted"></span></div></h3>
							...
							<div class="card-body">
								...
								<form autocomplete="off" action="editTransportMaster.php" enctype="multipart/form-data" method="post">
								<?php
											include("database/db_conection.php");//make connection here
											if(isset($_GET['id']))
											{
												...
												$result = mysqli_query($dbcon, "SELECT * FROM transportmaster WHERE id=$id");
								...
								?>		
									...
									<div class="form-group col-md-12">
									  ...
									  <input type="text" class="form-control"  name="transname" value="<?php echo $transname;?>" />
									</div>
									</div>
									...
									<div class="form-group col-md-12">
									  ...
									  <input type="text" class="form-control" name="vtype" value="<?php echo $vtype;?>" />
									</div>
									</div>
								    ...
								    <div class="form-group text-right m-b-10">
															<input type="hidden" name="transMasterId" value="<?=$_GET['id']?>">
                                                       &nbsp;<button class="btn btn-primary" name="transMasterEdit" type="submit">
                                                            Update
                                                        </button>                                                       
                                                    </div>
													</div>
