            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="breadcrumb-holder">
                        <h1 class="main-title float-left">HL Transactions History </h1>
                        <ol class="breadcrumb float-right">
                            <li class="breadcrumb-item">Home</li>
                            <li class="breadcrumb-item active">HL Transactions History </li>
                        </ol>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    <div class="card mb-3">
                        <div class="card-header">
                            ...
                            <h3><i class="fa fa-cart-plus bigfonts" aria-hidden="true"></i><b>&nbsp;HL Transactions History </b></h3>
                        </div>
                                    ...
                                    <table id="po_reports" class="table table-bordered" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            if((isset($_GET['st'])&&$_GET['st']!='')||(isset($_GET['end'])&&$_GET['end']!='')||(isset($_GET['partywise'])&&$_GET['partywise'])){
                                                ...
                                                $sql = "SELECT * from payeemasterlog p where 1=1 ";
                                                if($_GET['st']!=''){
                                                    if($st==$end){
                                                ...
                                                $sql = "SELECT * from payeemasterlog ;";    
                                            }
...
<script>
    ...
    $(document).ready(function() {
        ...
        var printhead = party_var!=''?'<p><b>Payee Transactions History Log Report: </b>'+party_var+'</p>':'';
        printhead+= date_range!=''?'<p><b>Date : </b>'+date_range+'</p>':'';
        var excel_printhead = party_var!=''?'Payee Transactions History Log Report : '+party_var:'';
        excel_printhead+= '  ';
        ...
        var table = $('#po_reports').DataTable( {
            ...
            //    }, 0 ).toFixed(2);
                ...
                $( api.column( 2 ).footer() ).html(grossval);
			//	$( api.column( 3 ).footer() ).html(grossval2);
            ...
            buttons: [
                {
                    ...
                    customize: function ( win ) {
                        $(win.document.body)
                            .css( 'font-size', '10pt' )
                            .prepend(
                            '<p><img src="<?php echo $baseurl;?>assets/images/logo/logo@0,25x.png" style="width:50px;height:50px;" /></p><p class="lead text-center"><b>Payee Transactions History Log Report</b><br/></p>'+printhead+'</div>'
                        );
                ...
                }, 
                {
                    ...
                    title:'Payee Transactions History', footer: true ,
    ...
    function get_po_reports(){
        ...
        location.href="payeeTransactionHistory.php?st="+st+"&end="+end+"&partywise="+partywise;
