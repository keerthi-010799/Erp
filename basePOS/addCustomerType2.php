...
if(isset($_POST['submit']))
{
   ...
   //$image =base64_encode($image);														
	...
	if(mysqli_query($dbcon,$insert_customerType))
	{
		...
		header("location:addCustomerProfile.php");
    } else {
							...
							<div class="card-body">
								...
								<form action="" class="validation fv-form fv-form-bootstrap" enctype="multipart/form-data" method="post" accept-charset="utf-8" novalidate="novalidate">
									...
									<div class="form-group col-md-10">
									  ...
									  <input type="text" class="form-control form-control-sm" name="custype" placeholder="Wholesaler,Distributor,Retailer" required >
									  </div>
