...
if(isset($_SESSION['login_email'])){
    ...
    $sq = "select username,mobile,firstname,lastname from userprofile where id='$userid'";
    $result = mysqli_query($dbcon, $sq) or die(mysqli_error($dbcon));
    //$count = mysqli_num_rows($result);
    $rs = mysqli_fetch_assoc($result);
    $session_user = $rs['username'];
    $session_mobile = $rs['mobile'];
    $session_mobile = $rs['mobile'];
...
<html lang="en">
    <head>
        ...
        <title>Online POS GST Software</title>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
						...
						<div class="fa fa-th-large bigfonts col">General<br><br><br>
							...
							<a href="listExpenses.php"><class="col">Expenses</a><br><br><br>
...
<div id="main">
    ...
    <div class="headerbar">
        ...
        <div class="headerbar-left">
            <a href="index.php" class="logo"><img alt="Logo" src="assets/images/avatars/favicon.jpeg" alt="Profile image" width="380" height="160"/> <font color="yellow"><span><b>SRI MAHESHWARI-POS</b></span></font></a>
        </div>
...
<a href="charts.html"><i class="fa fa-fw fa-area-chart"></i><span> Charts </span> </a>
			    ...
			    <li><a href="addCustomerProfileMaster.php"><i class="fa fa-plus-circle"></i>addCustomer</a></li>
...
<li><a href="listBankDeposit.php"><i class="fa fa-plus-circle"></i>List Bank deposit</a></li>
					...
					<li class="submenu">
                        ...
                        <a href"><i class="fa fa-cc-mastercard bigfonts" aria-hidden="true"></i>Hand Loans/Expenses<span class="menu-arrow"></span></a>	                        
                        <ul class="list-unstyled">	
                            
							<li><a href="listPayeeMaster.php"><i class="fa fa-user-md bigfonts" aria-hidden="true"></i> HL Account</a></li>
									<li><a href="payeeMasterReport.php"><i class="fa fa-fw fa-table"></i> <span> HL Balance Report</span></a></li>
                           
                             <!--li><a href="listSpaceName.php"><i class="fa fa-square-o bigfonts"></i>Location Names</a></li-->   
							 <!--li><a href="expenseReport.php"><i class="fa fa-fw fa-table"></i> <span> Expense Reports</span></a></li-->
							  <ul class="list-unstyled">								

                                </ul>	
								<li><a href="payeeTransactionHistory.php"><i class="fa fa-fw fa-table"></i> <span> HL Transaction History Report</span></a></li>
                                <li><a href="listVouchers2.php"><i class="fa fa-money bigfonts" aria-hidden="true"></i> Record Expenses</a></li>
                                <li><a href="listExpenses.php"><i class="fa fa-fw fa-table"></i> <span> Expense Report</span></a></li-->							 
                        </ul>
                    </li>
                    <!--li class="submenu">
