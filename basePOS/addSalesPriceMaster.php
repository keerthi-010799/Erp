...
$notes       = $_POST['notes'];
    ...
    $insert_salesPriceMaster="INSERT INTO salespricemaster(itemcode,taxmethod,taxrate,priceperqty,priceperuom,datefrom,notes) 
	VALUES('$itemcode','$taxmethod','$taxrate','$priceperqty','$priceperuom','$datefrom','$notes')";

    echo "$insert_salesPriceMaster";
    if(mysqli_query($dbcon,$insert_salesPriceMaster))
    {
        echo "<script>alert('Purchase Price Master creation Successful ')</script>";
        header("location:listSalesPriceMaster.php");
    } else {
        exit; 
			...
			<div class="container-fluid">
					...
					<div class="col-xl-12">
							<div class="breadcrumb-holder">
                                    <h1 class="main-title float-left">Sales Price Master</h1>
                                    <ol class="breadcrumb float-right">
										<li class="breadcrumb-item">Home</li>
										<li class="breadcrumb-item active">Item Sales Price</li>
                                    </ol>
                                    <div class="clearfix"></div>
                            </div>
					</div>
					...
					<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">						
						<div class="card mb-3">
							<div class="card-header">
								...
								<h3><class="fa-hover col-md-12 col-sm-12"><i class="fa fa-rupee bigfonts" aria-hidden="true"></i>
								Add Sales Item Price Master
								</h3>
								 ...
								 <form method="post" enctype="multipart/form-data">
										 <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label for="inputState">Sales Item Code</label>
                                                <select id="locname" onchange="onitemcode(this);" class="form-control" name="itemcode">
                                                    <option selected>Open Item Code</option>
                                                    <?php 
                                                    include("database/db_conection.php");//make connection here
                                                    $sql = mysqli_query($dbcon,"SELECT concat(prefix,substr(itemname,1,4),postfix,id) as code FROM salesitemaster");
                                                ...
                                                <script>
                                                    ...
                                                    {    
                                                        ...
                                                        window.location.href = 'addSalesPriceMaster.php?itemcode='+itemcode;
										...
										<div class="form-row">
                                            <div class="form-group col-md-8">
                                                ...
                                                $sql = mysqli_query($dbcon,"SELECT concat(prefix,substr(itemname,1,4),postfix,id) as code,itemname FROM salesitemaster");
												while ($row = $sql->fetch_assoc()){	
