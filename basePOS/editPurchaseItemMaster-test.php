...
{ 
    ...
    $sql = "UPDATE `purchaseitemaster` 
			SET `itemname` = '".$itemname."',
				...
				`stockinqty`='".$newstockinqty."',				
				`stockinuom`='".$stockinuom."',
							...
							<div class="card-body">
									...
									<?php
											...
											if(isset($_GET['id']))
											{
												...
												while($res = mysqli_fetch_array($result))
												{
													...
													$stockinqty 	=$res['stockinqty'];											 
 													//$newstockinqty  =$res['newstockinqty'];
											...
											<div class="form-group col-md-3">
                                                ...
                                                <!--select id="category" onchange="oncategory(this)" class="form-control form-control-sm" name="category">
                                                   <?php 
														include("database/db_conection.php");//make connection here
								...
								<div class="form-row">
								 ...
								 <div class="form-row">
									...
									<div class="form-group col-md-3">
									 ...
									 <input type="number" step="any" class="form-control form-control-sm" id="stockinqty" name="stockinqty" readonly value="<?php echo $stockinqty;?>" />
									</div>
										<div class="form-group col-md-3">
									 <label>New QTY</label>
									 <input type="number" step="any" class="form-control form-control-sm" id="newstockinqty" name="newstockinqty" readonly value="<?php echo $stockinqty;?>"  />
									</div>
									...
									<input type="number" step="any" onkeypress="update_math_valsAdjStock();"   onkeyup="update_math_valsAdjStock();" id="adjstockinqty" name="adjstockinqty" class="form-control form-control-sm"   />
									 ...
									 function update_math_valsAdjStock(){
										$('#newstockinqty').val(<?php echo $stockinqty;?>);

										 var adj = $('#adjstockinqty').val();
										// alert(adj);
										 var pri = $('#newstockinqty').val();
										  var pri2 = $('#stockinqty').val();
                                          var fin = +adj + +pri;
										//  alert(pri);
								
										 $('#newstockinqty').val(fin);
									 }
									 </script>
									 </div>
									...
									<!--input type="text" id="adjstock" name="adjstock" class="form-control form-control-sm"   /-->
									<input type="number" step="any" onkeypress="update_math_valsAdjUom();"   onkeyup="update_math_valsAdjUom();" id="adjstockinuom" name="adjstockinuom" class="form-control form-control-sm"   />
									 </div>
