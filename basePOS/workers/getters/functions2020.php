...
function update_open_balance($dbcon,$bal_type){
    if($bal_type=="payables"){
        ...
        $sql_q = "select SUM(inv_balance_amt) as recievables,inv_customer from invoices2020 where inv_payment_status!='Paid' and inv_status='Approved' group by inv_customer;";
        $exc_q = mysqli_query($dbcon,$sql_q)or die("Error");
