			...
			<div class="container-fluid">
					...
					<div class="col-xl-12">
							<div class="breadcrumb-holder">
                                    <h1 class="main-title float-left">Item Category List</h1>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">						
                            <div class="card mb-3">
                                <div class="card-header">
										...
										<a href="addItemCategory.php" class="btn btn-primary btn-sm">
										<i class="fa fa-user-plus" aria-hidden="true"></i>
										Add Item Category</a></span>
                                    <h3<i class="fa fa-cart-plus bigfonts" aria-hidden="true"></i><b> List Item Category </b></h3>
                        </div>
                            ...
                            <div class="table-responsive">
                                <table id="example1" class="table table-bordered table-hover display">
                                    ...
                                    <tbody>
                                        ...
                                        $sql = "select category,description,id from itemcategory order by id asc";
                                                ...
                                                echo '<td><a href="editPurchaseItemCategory.php?id=' . $row['id'] . '" class="btn btn-primary btn-sm" data-target="#modal_edit_user_5">
													...
													?>						
															...
															function deleteRecord_8(RecordId)
															{
																if (confirm('Confirm delete')) {
																	window.location.href = 'deletePurchaseItemCategory.php?id='+RecordId;
																}
															}
													</script>
                                    </tbody>
