                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <table id="po_reportsnodatatable" class="table table-bordered" style="width:100%">
                                        <thead>
                                            <tr>
                                                <th>Recipt ID</th>
                                                <th>Invoice#</th>
                                        ...
                                        <tbody>
                                            ...
                                            if((isset($_GET['st'])&&$_GET['st']!='')||(isset($_GET['end'])&&$_GET['end']!='')||(isset($_GET['custwise'])&&$_GET['custwise'])){ 
                                                ...
                                                $sql.=" and cp.cust_payment_customer=c.custid and i.inv_code=cp.cust_payment_invoice_no order by cp.id desc ;";    

                                            }else{
                                                $sql = "SELECT * from customer_paymentsacc cp,customerprofile c,invoicesacc i where cp.cust_payment_customer=c.custid and i.inv_code=cp.cust_payment_invoice_no order by cp.id desc ;";    
                                            }
            ...
            buttons: [
                {
                    ...
                    customize: function ( win ) {
                        $(win.document.body)
                            .css( 'font-size', '10pt' )
                            .prepend(
                            '<p><img src="<?php echo $baseurl;?>assets/images/dhirajLogo.png" style="width:50px;height:50px;" /></p><p class="lead text-center"><b>Payments Received</b><br/></p>'+printhead+'</div>'
                        );
