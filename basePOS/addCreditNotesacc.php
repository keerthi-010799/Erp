    ...
    <script>
        ...
        $(function(){
            ...
            if(page_action=="add"&&page_inv_code!=''){
                var inv_data = Page.get_edit_vals(page_inv_code,"invoicesacc","inv_code");
    ...
    <script>
        ...
        $("form#addcreditnote_form").submit(function(e){
            ...
            for(i=1;i<rowCount;i++){ 
                ...
                var tax_method = 1;//$('#tb tr').eq(i).find('#taxname').attr('data-taxmethod');
            ...
            $.ajax ({
                url: 'workers/setters/save_creditnoteacc.php',
                type: 'post',
