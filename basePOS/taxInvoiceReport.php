            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="breadcrumb-holder">
                        <h1 class="main-title float-left"> Tax Invoice Report</h1>
                        <ol class="breadcrumb float-right">
                            <li class="breadcrumb-item">Home</li>
                            <li class="breadcrumb-item active"> Tax Invoice Report</li>
                        </ol>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    <div class="card mb-3">
                        <div class="card-header">
                            ...
                            <h3><i class="fa fa-cart-plus bigfonts" aria-hidden="true"></i><b>&nbsp;Tax Invoice Report</b></h3>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <span id="tax_inv_reports_div"></span>
                                    <table id="tax_inv_reports" class="table table-bordered" style="width:100%">
                                        <thead>
                                            <tr>
                                            <th>Invoice#</th>												
                                            <th>Phone</th>												
...
<script>
    ...
    $(document).ready(function() {
        ...
        var table = $('#tax_inv_reports').DataTable( {
            lengthChange: false,
            "footerCallback": function ( row, data, start, end, display ) {
                ...
                $( api.column( 5 ).footer() ).html(totalBalance);
    ...
    function get_custrec_reports(){
        ...
        location.href="taxInvoiceReport.php?st="+st+"&end="+end+"&custwise="+custwise;
