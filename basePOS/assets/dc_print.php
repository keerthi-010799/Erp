...
<html>
 ...
 <b>FSSAI Lic.No</b> - 10012044000439
                    </td>
                ...
                <table class="p_table" width="100%" style="border:1px solid #000;display:none;">
                    <tbody>
                        <tr>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td width="" style="padding:10px;"><br/><br/>
                                <p style="text-align: center;"><b>For</b> <b><?php echo $row1['orgname']; ?></b><br/>
							   <br/><br/>
