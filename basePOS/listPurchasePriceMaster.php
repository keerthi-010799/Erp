						...
						<div class="row">
									<div class="col-xl-12">
											<div class="breadcrumb-holder">
													<h1 class="main-title float-left">Purchased Price List</h1>
													<ol class="breadcrumb float-right">
														<li class="breadcrumb-item">Home</li>
														<li class="breadcrumb-item active">Purchased Price List</li>
													</ol>
													<div class="clearfix"></div>
											</div>
									</div>
						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">						
							<div class="card mb-3">
								<div class="card-header">
										...
										<a href="addPurchasePriceMaster.php" class="btn btn-primary btn-sm"><i class="fa fa-user-plus" aria-hidden="true"></i>
										Add Purchase Price Master</a></span>
								
									<h3<i class="fa fa-rupee bigfonts" aria-hidden="true"></i><b> Purchase Price List </b></h3>
								</div>
									...
									<table id="example1" class="table table-bordered table-hover display">
										...
										<tbody>
											...
											<?php
													...
													echo '<td><a href="editPurchasePriceMaster.php?id=' . $row['id'] . '" class="btn btn-primary btn-sm" data-target="#modal_edit_user_5">
													...
													?>						
															...
															function deleteRecord_8(RecordId)
															{
																if (confirm('Confirm delete')) {
																	window.location.href = 'deletePurchasePriceMaster.php?id='+RecordId;
																}
															}
													</script>
