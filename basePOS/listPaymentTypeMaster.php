                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="breadcrumb-holder">
                                <h1 class="main-title float-left">List Payment Type</h1>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">						
                            <div class="card mb-3">
                                <div class="card-header">
										...
										<a href="addPaymentTypeMaster.php" class="btn btn-primary btn-sm"><i class="fa fa-user-plus" aria-hidden="true"></i>
										Add payment Type</a></span>

                                    <h3<i class="fa fa-bank smallfonts" aria-hidden="true"></i><b> List Payment Type </b></h3>
                        </div>
                                ...
                                <table id="example1" class="table table-bordered table-hover display">
                                    ...
                                    <tbody>
                                        ...
                                        $sql = "select paymentterm,description,id from paymentterm order by id asc";
                                                ...
                                                echo '<td><a href="editPaymentTypeMaster.php?id=' . $row['id'] . '" class="btn btn-primary btn-sm" data-target="#modal_edit_user_5">
													...
													?>						
															...
															function deleteRecord_8(RecordId)
															{
																if (confirm('Confirm delete')) {
																	window.location.href = 'deletePaymentTypeMaster.php?id='+RecordId;
																}
															}
													</script>
