                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="breadcrumb-holder">
                                <h1 class="main-title float-left">List Organization Master</h1>
                                <ol class="breadcrumb float-right">
                                    <li class="breadcrumb-item">Home</li>
                                    <li class="breadcrumb-item active">List Organization Master</li>
                                </ol>
                                <div class="clearfix"></div>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">						
                            <div class="card mb-3">
                                <div class="card-header">
										...
										<a href="addCompanyTypeMaster.php" class="btn btn-primary btn-sm"><i class="fa fa-user-plus" aria-hidden="true"></i>
										Add Organization</a></span>

                                    <h3<i class="fa fa-bank smallfonts" aria-hidden="true"></i><b> List Organization Master </b></h3>
                        </div>
                            ...
                            <div class="table-responsive">
                                <table id="example1" class="table table-bordered table-hover display">
                                    ...
                                    <tbody>
                                        ...
                                        $sql = "select concat(prefix,substr(cType,1,4),postfix,id) as code,name,cType,location,id from comptypecode order by id asc";
                                        ...
                                        if ($result->num_rows > 0){
                                            while ($row =$result-> fetch_assoc()){
                                                ...
                                                echo '<td><a href="editCompType.php?id=' . $row['id'] . '" class="btn btn-primary btn-sm" data-target="#modal_edit_user_5">
														<i class="fa fa-pencil" aria-hidden="true"></i></a>

													<a onclick="delete_record(this);" id="compTypeDelete" data-id="' . $row_id . '" class="btn btn-danger btn-sm"  data-title="Delete">
                                            ...
                                            function delete_record(x)
                                            {
                                               ...
                                               alert(row_id);
                                                if (confirm('Confirm delete')) {
                                                  window.location.href = 'compTypeDelete.php?id='+row_id;
                                               }
                                            }
