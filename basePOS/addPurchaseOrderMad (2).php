    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" id="close_cutom" data-dismiss="modal">Close</button>
                            ...
                            <form id="add_po_form" autocomplete="off" action="#">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-4">											
                                        ...
                                        <select id="po_payterm"  class="form-control"  name="po_payterm">
                                            <option selected>Open Payment Term</option>
                                        </select>



                                        <a href="#" data-target="#customModal" data-toggle="modal">
...
<!-- END Java Script for this page <script src="assets/js/pikeadmin.js"></script>-->
