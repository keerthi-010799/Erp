                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <form id="add_inv_form" autocomplete="off" action="#">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-8">
                                        <label for="inputState">Shop Name<span class="text-danger">*</span></label>
                                ...
                                <!--div class="form-row" id="inv_code_row" style="display:none;">
                                    <div class="form-group col-md-8">
                                        ...
                                        <input type="text" readonly placeholder="Invoice No" name="inv_code" id="inv_code" class="form-control form-control-sm"> 
                                        <label id="invCodeErr" class="text-danger"></label>
                                    </div>
                                </div-->
                                ...
                                <div class="form-row" id="inv_code_row" style="display:none;">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" placeholder="Invoice No" readonly name="inv_code" id="inv_code" class="form-control form-control-sm"> 
                                    </div>
                                </div>
...
<option value="paid">Paid</option>
                                ...
                                <table  class="table table-hover small-text" id="tb">
                                    ...
                                    <tr>
                                        <td>
                                            <select name="itemcode" class="form-control form-control-sm itemcode" onchange="sales_rowitem.set_itemrow(this,'sales','manual');" id="item_select">
                                                ...
                                                <option value="<?php echo $r['id']; ?>"><?php echo substr($r['brand'],0,10)."-".substr($r['itemname'],0,15)."-".$r['size']."- [".$r['itemcode']."]" ?></option>
                                                <?php
                                                                                    }
                                                ?>
                                            </select>
...
<td><input type="text" name="itemcode" placeholder="Item Details" class="form-control"></td>-->
                                        ...
                                        <td><input id="price" type="text" name="price" placeholder="Rate/Qty" onkeypress="sales_rowitem.update_math_vals_for_manual();"   onkeyup="sales_rowitem.update_math_vals_for_manual();"   data-id="" class="form-control form-control-sm price"></td>
                                            ...
                                            <div class="row">
                                                <div class="col-md-8">												
                                                    <div class="form-group col-8" style="padding-left:0px;">
                                                        ...
                                                        <input class="form-control form-control-sm" onkeypress="sales_rowitem.update_math_vals_for_manual();"   onkeyup="sales_rowitem.update_math_vals_for_manual();" id="poadjustmentval" type="number" step="any" placeholder="Adjustment ">
                                                        <i class="fa fa-question-circle-o bigfonts" aria-hidden="true" data-toggle="popover" 
...
$('document').ready(function(){
	$('#inv_code').change(function(){
		var invCode = $('#inv_code').val();
		$.ajax ({
           ...
           success:function(response){
				if(response!=0){
					$('#invCodeErr').html(invCode+' Invoice# already exists,please try another code');
                    $('#inv_code').val('');
				} else {
                    $('#invCodeErr').html('');
                }
