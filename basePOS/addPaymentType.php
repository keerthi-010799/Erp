...
if(isset($_POST['submit']))
{
    ...
    $usertype=$_POST['usertype'];//same
	$compcode=$_POST['compcode'];
	
	

   //$image =base64_encode($image);														
	$insert_usercode="INSERT INTO usertypecode(`prefix`,`postfix`,`name`,`usertype`,`compcode`) 
	VALUES ('$prefix','$postfix','$name','$usertype','$compcode')";													    

	
	//echo "$insert_usercode";
	
	if(mysqli_query($dbcon,$insert_usercode))
	{
		echo "<script>alert('User Code/Type creation Successful ')</script>";
