...
{ 
	var_dump($_POST);
	extract($_POST);
    $updateUser = "UPDATE `location` SET `locname` = '".$locname."' WHERE `id` =".$locID;
					...
					<li class="submenu">
						<a href="#"><i class="fa fa-truck smallfonts" aria-hidden="true"></i><span>Inventory(Purchase)</span> <span class="menu-arrow"></span></a>
                            <ul class="list-unstyled">
								...
								<li><a href=""><i class="fa fa-circle-o"></i>list Stock Adjustment</a></li>
						   </ul>
						   </li>
			...
			<div class="container-fluid">
					...
					<div class="col-xl-12">
							<div class="breadcrumb-holder">
                                    <h1 class="main-title float-left">Edit Location</h1>
						...
						<div class="card mb-3">
							<div class="card-header">
								<!--h3><i class="fa fa-check-square-o"></i>Create Company </h3-->
								 ...
								 </i> Edit Location Details</div></h3>
							...
							<div class="card-body">
								...
								<form action="editLocation.php" class="validation fv-form fv-form-bootstrap" enctype="multipart/form-data" method="post" accept-charset="utf-8" novalidate="novalidate"><button type="submit" class="fv-hidden-submit" style="display: none; width: 0px; height: 0px;"></button>
								...
								<?php
											...
											if(isset($_GET['id']))
											{
												...
												$result = mysqli_query($dbcon, "SELECT * FROM location WHERE id=$id");
									...
									<div class="form-group col-md-12">
									  ...
									  <input type="text" class="form-control" name="locname" placeholder="HQ,Plant,Registered,Corporate,Warehouse," value="<?php echo $locname;?>" />
									</div>	
