...
if(isset($_POST['submit']))
{
   ...
   //$image =base64_encode($image);														
    ...
    $insert_purchaseItemMaster="insert into purchaseitemaster(`prefix`,`postfix`,`itemname`,`vendor`,`description`,
														`priceperqty`,`priceperuom`,`taxmethod`,`taxrate`,`pricedatefrom`,`stockinqty`,
														`stockinuom`,`reorderlevel`,`qtyondemand`,`usageunit`, `handler`,`notes`)
										VALUES ('$prefix','$postfix','$itemname','$vendor','$description','$priceperqty','$priceperuom',
										'$taxmethod','$taxrate','$pricedatefrom','$stockinqty','$stockinuom','$reorderlevel','$qtyondemand','$usageunit','$handler','$notes')";
	
	echo "$insert_purchaseItemMaster";
	
	if(mysqli_query($dbcon,$insert_purchaseItemMaster))
	{
					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">						
						<div class="card mb-3">
							...
							<div class="card-body">
								...
								<form action="" class="validation fv-form fv-form-bootstrap" enctype="multipart/form-data" method="post" accept-charset="utf-8" novalidate="novalidate">
								<button type="submit" class="fv-hidden-submit" style="display: none; width: 0px; height: 0px;"></button>
									...
									<i class="fa fa-rupee fonts" aria-hidden="true"></i>
									<label>Price/UOM&nbsp;<span class="text-danger"><i class="fa fa-question-circle-o bigfonts" aria-hidden="true" data-toggle="popover" 
									...
									<div class="form-row">
									<div class="form-group col-md-3">
									 <label>Date From<span class="text-danger">*</label>&nbsp;</span><span class="text-danger"><i class="fa fa-question-circle-o bigfonts" aria-hidden="true" data-toggle="popover" 
								 ...
								 <div class="form-row">
									...
									<div class="form-group col-md-3">									  
									  ...
									  <input type="text" class="form-control form-control-sm" name="reorderlevel" placeholder="Short notes about Product"  required class="form-control" autocomplete="off">
									</div>
									...
									<div class="invoice-title text-left mb-8">
									  ...
									  <input type="text" class="form-control form-control-sm" name="qtyondemand" placeholder="Short notes about Product"  required class="form-control" autocomplete="off">
									</div>
									</div>
									</div>
									</div>
									...
									<div class="form-group col-md-6">
									 <label>Add Notes</label></span>
									  <textarea rows="2" class="form-control editor" name="notes" placeholder="add product related updates/notes here"></textarea>
									</div> 
								</div>
