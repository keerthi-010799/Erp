...
{ 
	...
	$statusPaid="SELECT status ,id FROM payeemaster WHERE status = '1' and id =".$PayID;
  $run_query=mysqli_query($dbcon,$statusPaid);
	if(mysqli_num_rows($run_query)>0)
  {
     $statusPaid = "HL  is already been PAID. You are not allowed to Update!";
      // exit;
			...
			<div class="container-fluid">
					...
					<div class="col-xl-12">
							<div class="breadcrumb-holder">
                                    <h1 class="main-title float-left">Edit Loan Details </h1>
                                    <ol class="breadcrumb float-right">
										<a  href="index.php"><li class="breadcrumb-item">Home</a></li>
										<li class="breadcrumb-item active">Edit Loan Details </li>
                                    </ol>
					...
					<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 col-xl-8">						
						<div class="card mb-3">
							<div class="card-header">
								...
								<p class="text-danger"><?php echo $statusPaid;?></p>
								...
								<div class="form-row">
                                	<div class="form-group col-md-10">	
										<label>Edit Amount</label>												
											 <input type="text" name="amount" class="form-control" id="amount"  value="<?php echo $amount;?>" data-default="<?php echo $amount;?>" />
										</div>										
								 ...
								 <script>
									...
									<div class="form-group col-md-10">							
											...
											<!--div class="form-group col-md-5">	
												...
												<input type="text" name="reference" class="form-control form-control-sm " value="<?php echo $reference;?>" />
												</div-->
									</div>
									...
									<div class="form-row">	
									<div class="form-group col-md-10">							   
								 <select id="groupname" onchange="ongroup(this)" required class="form-control form-control-sm" name="status">
