                            ...
                            <div class="table-responsive">
                                <table id="listinvoicestable" class="table table-bordered table-hover display">
                                    ...
                                    <tbody>
                                        ...
                                        $sql = "SELECT i.*,c.* FROM invoices2020 i,customerprofile c where c.custid=i.inv_customer
										ORDER BY i.id DESC ";
                ...
                <script>
                    ...
                    function ToPrint(el){
                        ...
                        var template= $(el).attr('data-template');
                            if(template=="sales_credit_inv2020"){
