...
if(isset($_POST['submit']))
{
   ...
   //$image =base64_encode($image);														
	$insert_paymentype="INSERT INTO paymentype(`paymentype`,`description`) 
	VALUES ('$paymentype','$description')";													    

	
	//echo "$insert_paymentype";
	
	if(mysqli_query($dbcon,$insert_paymentype))
	{
		echo "<script>alert('paymentype creation Successful ')</script>";
		header("location:listPaymentTypeMaster.php");
    } else {
			...
			<div class="container-fluid">
					...
					<div class="col-xl-12">
							<div class="breadcrumb-holder">
                                    <h1 class="main-title float-left">Payment Type Master</h1>
						...
						<div class="card mb-3">
							<div class="card-header">
								<!--h3><i class="fa fa-check-square-o"></i>Create Company </h3-->
								 ...
								 </i>Add Payment Type Master </div></h3>
							...
							<div class="card-body">
								...
								<form autocomplete="off" action="#" enctype="multipart/form-data" method="post">
									...
									<div class="form-group col-md-10">
									  ...
									  <input type="text" class="form-control" name="paymentype" placeholder="Advance,Due30Days,Due60Days,Immediate" required class="form-control" autocomplete="off">
									</div>
								  	    <div class="form-group col-md-10">
