...
{ 
	var_dump($_POST);
	extract($_POST);
    $updateCompBankDetails = "UPDATE `suppbank` SET  `bankname` = '".$bankname."', `acctno` = '".$acctno."',
					...
					<div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 col-xl-8">						
						<div class="card mb-3">
							...
							<div class="card-body">
								...
								<form action="editSupplierBankDetails.php"  enctype="multipart/form-data" method="post" accept-charset="utf-8" novalidate="novalidate"><button type="submit" class="fv-hidden-submit" style="display: none; width: 0px; height: 0px;"></button>
								...
								<?php
											...
											if(isset($_GET['id']))
											{
												...
												$result = mysqli_query($dbcon, "SELECT * FROM suppbank WHERE id=$id");									 
									...
									<div class="form-group col-md-6">
									  <label for="inputZip">Supplier Code<span class="text-danger">*</span></label>
									  <input type="text" class="form-control"  name="supcode" placeholder="Axis Bank..." readonly  value="<?php echo $supcode;?>" />
									</div>
									</div>
