					...
					<li class="submenu">
                        <a href="#"><i class="fa fa-bank bigfonts" aria-hidden="true"></i> <span>Company</span> <span class="menu-arrow"></span></a>
                            <ul class="list-unstyled">
                                ...
                                <li><a href=""><i class="fa fa-circle-o"></i>add Profile</a></li>
                        ...
                        <a href="#"><i class="fa fa-th-list bigfonts" aria-hidden="true"></i><span>Masters</span></a>
                            <ul class="list-unstyled">								
								...
								<li><a href="addPaymentTypeMaster.html"><i class="fa fa-circle-o"></i> Payment Type</a></li>
								 ...
								 <li><a href="listLocation"><i class="fa fa-circle-o"></i>list Location</a></li>	
							</ul>
</li>						
						...
						<div class="row">
									<div class="col-xl-12">
											<div class="breadcrumb-holder">
													<h1 class="main-title float-left">List Location</h1>
						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">						
							<div class="card mb-3">
								...
								<span class="pull-right">
										<a href="addLocationMaster.php" class="btn btn-primary btn-sm"><i class="fa fa-plus" aria-hidden="true"></i>
										Add Location</a></span>
								
									<h3<i class="fa fa-bank smallfonts" aria-hidden="true"></i><b> List Location </b></h3>
								</div>
									...
									<table id="example1" class="table table-bordered table-hover display">
										...
										<tbody>
											...
											<?php												
													...
													$sql = "select concat(prefix,substr(cType,1,3),id) as code,id,cType from comptypecode";
													...
													<script>
															function deleteRecord_8(RecordId)
															{
																if (confirm('Confirm delete')) {
																	window.location.href = 'compTypeDelete.php?id='+RecordId;
																}
															}
													</script>
