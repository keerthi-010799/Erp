                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <span id="inv_reports_div"></span>
                                    <table id="inv_reports" class="table table-bordered" style="width:100%">
                                        <thead>
                                            <tr>
                                            <th>Invoice#</th>												
                                            <th>Phone</th>												
...
<script>
    ...
    $(document).ready(function() {
        ...
        var table = $('#inv_reports').DataTable( {
            lengthChange: false,
    ...
    function get_custrec_reports(){
        ...
        location.href="manualInvoiceReport.php?st="+st+"&end="+end+"&custwise="+custwise;
