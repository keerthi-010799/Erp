...
if(isset($_POST['pTypeEdit']))
{ 
	var_dump($_POST);
	extract($_POST);
	
    $updatePaymentTerm = "UPDATE `paymentterm` SET `paymentterm` = '".$paymentterm."',`description` = '".$desc."'
										WHERE `id` =".$ptypeid;
	//echo $updatePaymentType;
    if(mysqli_query($dbcon,$updatePaymentTerm))
    {
		echo "<script>alert('Payment Type Successfully updated')</script>";
			...
			<div class="container-fluid">
					...
					<div class="col-xl-12">
							<div class="breadcrumb-holder">
                                    <h1 class="main-title float-left">Edit Payment Type Master</h1>
                                    <ol class="breadcrumb float-right">
									<a  href="index.php"><li class="breadcrumb-item">Home</a></li>
										<li class="breadcrumb-item active">Edit Payment Type Master</li>
                                    </ol>
                                    <div class="clearfix"></div>
                            </div>
					</div>
						...
						<div class="card mb-3">
							<div class="card-header">
								<!--h3><i class="fa fa-check-square-o"></i>Create Company </h3-->
								 ...
								 </i>Edit Payment Type Master </div></h3>
							...
							<div class="card-body">
									...
									<form method="post" action="editPaymentTypeMaster.php"  enctype="multipart/form-data">
											<?php
											include("database/db_conection.php");//make connection here
											if(isset($_GET['id']))
											{
												...
												$result = mysqli_query($dbcon, "SELECT * FROM paymentterm WHERE id=$id");
												while($res = mysqli_fetch_array($result))
												{
													$paymentype = $res['paymentterm'];
									...
									<div class="form-group col-md-10">
									  ...
									  <input type="text" class="form-control" name="paymentterm"  value="<?php echo $paymentterm;?>"/>
									</div>
								  	    <div class="form-group col-md-10">
								     ...
								     <div class="modal-footer">
										<input type="hidden" name="ptypeid" value="<?=$_GET['id']?>">
										<button type="submit" name="pTypeEdit" value="pTypeEdit" class="btn btn-primary">Update</button>
									</div>
